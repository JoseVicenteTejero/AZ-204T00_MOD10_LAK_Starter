...
1. 1. Enter      the following command, and then select Enter to get a list of subgroups      and commands at the root level of the Azure CLI:
...
1. 1. In      the **Name** text box, enter **hrtopic\*[yourname]\***.
...
1. 1. From      the **Options** drop-down list, select **Single      Container**.
...
3. Select **Create** to     create the web app using your specified configuration.
...
1. 1. In      the **Name** text box, enter **basicsub**.
...
1. 1. Add      the following line of code to create a new variable named **credentials** of      type [**TopicCredentials**](https://microsoftlearning.github.io/AZ-204-DevelopingSolutionsforMicrosoftAzure/Instructions/Labs/AZ-204_10_lab_ak.html), using the **topicKey** string      constant as a constructor parameter:
