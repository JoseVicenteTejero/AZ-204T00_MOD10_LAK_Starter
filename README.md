...
6.	At the command prompt, enter the following command, and then select Enter to import version 3.2.0 of Microsoft.Azure.EventGrid from NuGet:
CodeCopy
...
2.	Add the following line of code to create a new variable named client of type EventGridClient, using the credentials variable as a constructor parameter:
CodeCopy
EventGridClient client = new EventGridClient(credentials);
3.	Add the following line of code to create a new variable named events of type **List**.
CodeCopy
List<EventGridEvent> events = new List<EventGridEvent>();
4.	Add the following lines of code to create a new variable named firstPerson of an anonymous type:
CodeCopy
var firstPerson = new
{
...
5.	Add the following block of code to create a new variable named firstEvent of type EventGridEvent, and then populate the EventGridEvent variable with sample data:
CodeCopy
...
6.	Add the following line of code to add the firstEvent instance to your events list:
CodeCopy
events.Add(firstEvent);
7.	Add the following line of code to create a new variable named secondPerson of an anonymous type:
CodeCopy
...
8.	Add the following block of code to create a new variable named secondEvent of type EventGridEvent, and then populate the EventGridEvent variable with sample data:
CodeCopy
...
9.	Add the following line of code to add the secondEvent instance to your events list:
CodeCopy
events.Add(secondEvent);
10.	Add the following line of code to obtain the Hostname from the topicEndpoint variable:
CodeCopy
string topicHostname = new Uri(topicEndpoint).Host;
11.	Add the following line of code to invoke the EventGridClient.PublishEventsAsync method using the topicHostname and events variables as parameters:
CodeCopy
await client.PublishEventsAsync(topicHostname, events);
12.	Add the following line of code to render the Events published message to the console:
CodeCopy
